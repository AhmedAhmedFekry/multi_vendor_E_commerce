...
def checkout(request, first_name, last_name, email, address, zipcode, place, phone, amount):
    order = Order.objects.create(first_name=first_name, last_name=last_name, email=email,
                                 address=address, zipcode=zipcode, place=place, phone=phone, paid_amount=amount)
...
def notify_vendor(order):
    ...
    print('notify order vendor pppppppppppppppppppppppppppppppppppp')
...
def notify_customer(order):
    from_email = settings.DEFAULT_EMAIL_FROM
    print('notify order customer pppppppppppppppppppppppppppppppppppp')
